...
#            if start != 'n' and start!='r' and start!='e':
#                raise InvalidInput
#        #* If the user tries to replay a hand on the first run.        
#            if start == 'r' and hand == {}:
#                raise FalseStart
#        # * If the user inputs 'e', exit the game.
#            if start == 'e':
#                game=False
#            while (start !='e') and (start =='n' or start =='r'):
#                comp=input('Enter u to have yourself play, c to have the computer play:')
#                try:
#                    if comp!='c' and comp!='u':
#                        raise InvalidInput
#                    elif comp=='u' and start == 'r':
#            # * If the user inputs 'r', let the user play the last hand again.
#                        playHand(hand,wordList,HAND_SIZE)
#            #* If the user inputs 'n', let the user play a new (random) hand.
#                    elif comp =='u' and start =='n':
#                        hand=dealHand(HAND_SIZE)
#                        playHand(hand,wordList,HAND_SIZE)
#                    elif comp == 'c' and start =='r':
#                        compPlayHand(hand,wordList,HAND_SIZE)
#                    else:
#                        hand=dealHand(HAND_SIZE)
#                        compPlayHand(hand, wordList, HAND_SIZE)        
